...
public class Main {
    public static void main(String[] args) {
        ...
        Assignment assignment1 = new Assignment(LocalDate.now().plusDays(7), true, course1);
        Assignment assignment2 = new Assignment(LocalDate.now().plusDays(10), false, course2);

        teacher.addAssignment(course1, assignment1);
        teacher.addAssignment(course2, assignment2);

        Project project1 = new Project(LocalDate.now().plusDays(7), true, course1, "Math Project");
        Project project2 = new Project(LocalDate.now().plusDays(10), false, course2, "English Project");
